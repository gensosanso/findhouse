          ...
          <div className="row">
            <div className="col-lg-6 offset-lg-3">
              <div className="main-title text-center">
                <h2 className="mt0">Notre Mission A FindHouse</h2>
              </div>
            </div>
          </div>
          {/* End .row */}
          ...
          <div className="row mt80">
            <div className="col-lg-6 offset-lg-3">
              <div className="main-title text-center">
                ...
                <p>Nous fournissons un service complet à chaque étape.</p>
              </div>
            </div>
          </div>
          {/* End .row */}
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 offset-lg-3">
              <div className="main-title text-center">
                <h2>Notre equipe</h2>
                <p>Notre armee de facilitateurs</p>
              </div>
            </div>
          </div>
          <div className="row">
          ...
          <div className="row">
            <div className="col-lg-6 offset-lg-3">
              <div className="main-title text-center">
                ...
                <p>Nous travaillons uniquement avec les meilleures entreprises du monde</p>
              </div>
            </div>
          </div>
          <div className="row">
