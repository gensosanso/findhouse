    ...
    <>
      <div className="col-sm-6 col-md-6 col-lg-3 col-xl-3 pr0 pl0">
        <div className="footer_about_widget">
          ...
          <p>
          Nous réinventons la façon dont vous achetez, vendez et louez. 
          Il est désormais plus facile d’entrer dans un endroit que vous aimez. 
          Alors faisons-le ensemble. Devenez un Partenaire
          </p>
        </div>
      </div>
      {/* End .col */}
